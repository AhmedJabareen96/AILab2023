...
function genetic_algorithm(pop_size::Int64, num_genes::Int64, fitness_func::Function, max_generations::Int64)
    ...
    for generation in 1:max_generations
        ...
        println("The average of the fitness of the current generation is: $(average)")
        println("The standard_dev of the fitness of the current generation is: $(standard_dev)")
